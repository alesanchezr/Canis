<?php
/*
Este archivo se incova cuando se tiene definido un schema.yml y se quiere
generar toda la base de datos y clases para ese schema. Una vez invocado
se pueden referenciar todas las clases en cualquier parte del framework, Ej:
