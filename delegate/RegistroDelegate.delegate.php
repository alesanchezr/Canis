		...
		*/
		...
		if($validator->getTotalErrors()==0)
		{
			...
			try {
				...
				$body = 'Hi '.$email.', Welcome to IVoted.com!, your validation code is '.$random.'. Before you can log into the system you must click on the following link: http://www.ivoted.com/crud.php?public_action=validate&a='.$random.'&b='.$entity->id;
				...
				$mail->AddBCC($email);
				$mail->Subject  = "IVoted.com Registration";
